...
def execute_greet_smoothswitch():
    ...
    if os.path.exists(audio_file):
        ...
        # Initial position - look up and slightly to the left
        misty.move_head(pitch=-12, roll=0, yaw=15)  # Look up and a little left
        ...
        misty.move_head(pitch=-12, roll=0, yaw=30)  # Head turn left with raised angle
